...
export default function OwnerPortalPage() {
    ...
    const { garageSale, products, sales, summary, metrics } = data;
        ...
        <div className="mx-auto max-w-6xl px-4 py-6 pb-16">
            ...
            {tab === "contratos" && (
                <section className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
                    <h2 className="text-lg font-semibold text-stone-900">Contratos e termos</h2>
                    <p className="mt-2 text-sm text-stone-600">
                        Texto vinculado ao evento (regras e termos cadastrados pela organização).
                    </p>
                    <div className="mt-4 rounded-xl border border-stone-100 bg-stone-50 p-4 text-sm leading-relaxed text-stone-800 whitespace-pre-wrap">
                        {garageSale.regras?.trim() ? garageSale.regras : "Nenhum contrato ou termo foi cadastrado para este evento."}
                    </div>
                </section>
            )}
