...
export default async function SiteHeader() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-[100] flex h-24 items-center border-b border-stone-200 bg-white/95 px-4 shadow-sm backdrop-blur-md">
            ...
            >
                <GestorGarageLogo className="h-10 w-10 shrink-0 drop-shadow-sm sm:h-11 sm:w-11" aria-hidden />
                <span className="flex min-w-0 flex-col leading-tight">
                    <span className="text-xl font-bold tracking-tight text-stone-900 sm:text-2xl">Gestor Garage</span>
